...
import { ChildData } from "@/types/types"; // Define ChildData type in your types
...
const EditChildModal: React.FC<EditChildModalProps> = ({ childData, isOpen, onClose, onSave }) => {
  const [formData, setFormData] = useState<ChildData>(childData);
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-8 rounded-lg shadow-lg w-11/12 md:w-1/2 lg:w-1/3 max-h-3/4 overflow-y-auto">
        <h2 className="text-2xl mb-4">Edit Child Information</h2>
